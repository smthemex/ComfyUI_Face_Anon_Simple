...
from .referencenet_transformer_2d import Transformer2DModel
    ...
    def forward(
        ...
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states, referencenet_output = attn(
                    hidden_states,
                    encoder_hidden_states=encoder_hidden_states,
                    cross_attention_kwargs=cross_attention_kwargs,
                    attention_mask=attention_mask,
...
class CrossAttnDownBlock2D(nn.Module):
    ...
    def forward(
        ...
        torch.FloatTensor, Tuple[torch.FloatTensor, ...], Tuple[torch.FloatTensor, ...]
    ]:
        output_states = ()
        referencenet_states = ()
        ...
        return hidden_states, output_states, referencenet_states
